...
# -------------------------------
# Complete Seller Model
# -------------------------------
class Seller(models.Model):
    """Complete seller model with full e-commerce functionality"""
...
class OrderItem(models.Model):
    ...
    book_type = models.CharField(max_length=10, choices=[('hard', 'Hard Copy'), ('soft', 'Soft Copy')], default='soft')

    def __str__(self):
        return f"{self.book.title} - {self.quantity}x"
...
class Inventory(models.Model):
    ...
    def total_stock(self):
        return self.hard_stock + self.soft_stock
...
class SellerAnalytics(models.Model):
    ...
    def __str__(self):
        return f"Analytics for {self.seller.business_name or self.seller.user.username}"